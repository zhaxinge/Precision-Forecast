...
The factors are calculated with the formular below: 
...
The plots presented here illustrate that in Portsmouth, the Median household income, percentage of white population change, and unit change exhibits a different pattern in areas where land cover changed from pervious to impervious between 2014 and 2018 (1) compared to the other situations (0). In James city, all five factors show different pattern across the two categories, but percentage of white population change various the most. In Isle of wight, percentage of white population change, total population change and unit change exhibits a different pattern in areas where land cover changed from pervious to impervious between 2014 and 2018 (1) compared to the other situations (0).                  
...
We calculated MAPE fo each cencus block group to test the model’s generalizability. The results indicate at Portsmouth, that our model has a low MAPE for majority of the neighborhood and slightly higher MAPE in some block groups down the south.  In James city, MAPE is relatively consistent across the block groups. In Isle of Wight, 
