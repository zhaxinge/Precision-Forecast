...
We calculated MAPE for each census block group to test the model’s generalizability. The results indicate at Portsmouth that our model has a low MAPE for the majority of the neighborhood and slightly higher MAPE in some block groups down the south. In James City, MAPE is relatively consistent across the block groups. In the Isle of Wight, 
